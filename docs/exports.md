...
| **Cessions au format 2086**           | `#/report`, au-dessus du second avis          | Une ligne par cession de l'**année déclarée**, une colonne par **ligne du formulaire**, numéro compris : date (211), valeur globale du portefeuille (212), prix de cession (213), frais (214), prix net des frais (215), prix total d'acquisition (220), fractions de capital initial déjà imputées (221), prix total d'acquisition net (223), plus ou moins-value de la cession, et si elle a pu être chiffrée. Les soultes (216, 222) n'ont pas de colonne : l'app n'en connaît aucune, et une case vide vaut zéro. **Aide au report, pas une déclaration.** |
