...
`CONCENTRATION_NOTE`, `CONCENTRATION_HIGH`, `STABLE_SHARE_MIN`, `PRIORITY`).
...
calculent sur les données déjà présentes dans le navigateur. Les briques suivantes de l'étude
(P30 aperçu fiscal avant cession, P31 risque et structure, P32 projections, P34 contexte de marché,
P35 alertes composées) restent des propositions.
