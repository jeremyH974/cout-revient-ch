...
116. **Un stub de prix cote l'actif qu'on lui demande, sinon il fabrique des invariants faux**
     (08/09/2026).
...
122. **Crypto et actions sont deux volets d'un même espace, pas deux espaces** (08/09/2026).
...
136. **Le jeu de démonstration ne portait pas le piège qu'il était censé garder** (08/09/2026).
...
173. **Deux rendus, deux séquences écrites à la main — et l'une avait perdu une section** (20/09/2026).
