...
const ACTIVITY: FixtureSheet = {
  ...
  rows: [
    ...
    ['12/02/2025 09:30:00', 'Position ouverte', 'DEMO', 400, 10, 0, 0, 4600, 'p-101', 'Actions', 0],
    ['03/03/2025 11:00:00', 'Position ouverte', 'IDX', 450, 5, 0, 0, 4150, 'p-102', 'ETF', 0],
    [
      '20/05/2025 16:45:00',
      'Position ouverte',
      'ZCH',
    ...
    ['02/06/2025 10:00:00', 'Position ouverte', 'LEVR', 60, 3, 0, 0, 3490, 'p-104', 'Actions', 0],
    ['15/07/2025 12:00:00', 'Frais overnight', 'LEVR', -2, '-', 0, 0, 3488, 'p-104', 'Actions', 0],
  ],
};
