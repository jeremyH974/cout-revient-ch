...
export const MACRO: MacroSnapshot = {
  generatedAt: '2026-08-29T07:30:46Z',
  sources: [
    { source: 'treasury', checkedOn: '2026-08-29', count: 3 },
    { source: 'fed', checkedOn: '2026-08-29', count: 1 },
    { source: 'eia', checkedOn: '2026-08-29', count: 0, missing: 'clé EIA_API_KEY absente' },
  ],
  indicators: [
    {
      id: 'real-10y',
      ...
      staleAfterDays: 5,
      ranks: [
        { window: '1y', percentile: 96, observations: 251 },
        { window: '10y', percentile: 99.1, observations: 2499 },
      ],
      source: 'treasury',
    ...
    },
    {
      ...
      staleAfterDays: 5,
      ranks: [
        { window: '1y', percentile: 11.2, observations: 251 },
        { window: '10y', percentile: 49.6, observations: 2499 },
      ],
      source: 'treasury',
      url: 'https://home.treasury.gov/resource-center/data-chart-center/interest-rates/daily-treasury-rates',
      series: {
    ...
    },
    {
      ...
      ranks: [
        ...
        { window: '5y', percentile: 98.4, observations: 1249 },
      ],
      source: 'treasury',
      url: 'https://home.treasury.gov/resource-center/data-chart-center/interest-rates/daily-treasury-rates',
      series: {
